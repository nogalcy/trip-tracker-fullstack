# This is a navigation repo for the trip tracker fullstack project, as it is easier to deploy on Render when the frontend and backend are separate github repositories
